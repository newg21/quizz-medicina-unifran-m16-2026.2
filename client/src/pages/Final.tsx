  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-yellow-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        <div className="bg-white border-4 border-black shadow-lg px-5 py-6 md:px-10 md:py-8 text-center">
          <h1 className="text-4xl md:text-5xl font-black text-black mb-3 uppercase">
            Parabéns!
          </h1>

          <p className="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-5">
          ...
          <div className="bg-blue-600 text-white border-4 border-black px-4 py-3 md:px-5 mb-4 md:mb-5 text-center">
            <h2 className="text-base md:text-lg font-black uppercase mb-1">Dúvidas?</h2>
          ...
          <div className="text-center mb-5 md:mb-6">
            <p className="text-base md:text-lg font-bold text-gray-700 mb-1">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            <Button
              ...
              className="flex-1 bg-gray-600 hover:bg-gray-700 text-white font-black py-2.5 md:py-3 px-6 text-base md:text-lg border-3 border-black"
            >
